...
const createSendToken = (user, statusCode, req, res) => {
  ...
  res.cookie('jwt', token, {
    ...
    httpOnly: true,
    secure: req.secure || req.headers('x-farworded-proto') === 'https',
  });
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // 3) If everything is OK, send token  client
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  if (!(await user.correctPassword(req.body.passwordCurremt, user.password))) {
